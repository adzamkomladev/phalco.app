...
const electionImages: ImageItemProp[] = [
    {
        src: "https://via.placeholder.com/150/0000FF/FFFFFF?text=Election+Result+1",
        description: "Voters casting their votes during the election.",
    },
    {
        src: "https://via.placeholder.com/150/FF0000/FFFFFF?text=Election+Result+2",
        description: "Election officials counting the ballots.",
    },
    {
        src: "https://via.placeholder.com/150/00FF00/FFFFFF?text=Election+Result+3",
        description: "A candidate giving a victory speech.",
    },
    {
        src: "https://via.placeholder.com/150/FFFF00/FFFFFF?text=Election+Result+4",
        description: "A billboard displaying election results.",
    },
];
</script>
        ...
        <div class="">
            ...
            <div class="w-full overflow-hidden">
                <div class="mx-5 pt-4">
                    ...
                    >
                        <button
                            ...
                            id="basic-tabs-comments"
                            aria-selected="true"
                            data-hs-tab="#tabs-comments"
                            aria-controls="tabs-comments"
                            role="tab"
                        >
                            comments
                            <p
                                class="w-0 hs-tab-active:w-full trasition-all duration-500 border-b-[2px] -mb-[1px] hs-tab-active:border-primary-400 block"
                            ></p>
                        </button>
                        <button
                            type="button"
                            ...
                            aria-selected="false"
                            data-hs-tab="#tabs-images"
                            aria-controls="tabs-images"
                            role="tab"
                        >
                            images
                            <p
                                class="w-0 hs-tab-active:w-full place-self-right trasition-all duration-500 border-b-[2px] -mb-[1px] hs-tab-active:border-primary-400 block"
                            ></p>
                        </button>
                    </nav>
                </div>
                ...
                <div class="mt-3">
                    ...
                    >
                        <VotingRequestsShowFeedbackGallary
                            :images="electionImages"
                        />
                    </div>
                </div>
            </div>

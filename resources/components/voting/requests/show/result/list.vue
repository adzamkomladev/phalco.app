        ...
        >
          <div class="flex items-center gap-x-3">
            <img
              ...
              :src="'https://randomuser.me/api/portraits/men/' + option.optionPosition + '.jpg'"
            ...
            <div class="grow">
              ...
              >
                {{ option.optionfirstName }} {{ option.optionLastName }}
              </span>
          ...
          <div class="flex gap-4 mobile:gap-2">
            ...
            <span
              ...
              :class="[option.optionPosition === 1 ? 'bg-yellow-500 text-white' : '']"
            >

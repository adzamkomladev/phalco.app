...
<template>
    ...
    >
        ...
        <div class="text-center grid gap-5">
           ...
           <div class="w-[70%]  h-auto aspect-square rounded-full overflow-hidden place-self-center">
                        <img :src="'https://www.bing.com/th?id=OIP.5-mDBIk0BFx0D3b7_4ZgtAHaJF&w=120&h=150&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2'" class="w-full " />

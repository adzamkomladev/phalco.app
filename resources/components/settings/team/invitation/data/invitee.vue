     ...
     <tr
                                ...
                                >
                                    <td class="py-3 sm:pr-4 whitespace-nowrap">
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <div class="font-medium">
                                                <span
                                                    class="block text-sm text-black dark:text-gray-200"
                                                >
                                                    {{ invitee.email }}
                                                </span>
                                                <span
                                                    class="block text-sm text-gray-400 capitalize"
                                                >
                                                    {{ invitee.role?.name }}
                                                </span>
                                            </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <SharedCommonIcon name="reload" class="group-hover/reload:scale-125 transition-all" />
                                        </router-link>
                                        <router-link
                                            :href="
                                                route(
                                        ...
                                        >
                                            <SharedCommonIcon name="close" class="group-hover/cancel:scale-125 transition-all" />
                                        </router-link>
                                    </td>

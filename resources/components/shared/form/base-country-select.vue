...
onMounted(async () => {
    HSSelect.autoInit();
    const { element } = HSSelect.getInstance(select.value!, true) as any;

    const countries = await getCountries();
    const options: ISingleOption[] = countries.map(

   ...
   column.toggleSort();
                                    ...
                                    >
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            >
                                                {{ column.label }}
                                                <span v-if="column.isSortable" class="size-5 grid place-content-center">
                                                    <SharedCommonIcon 
                                                    v-if="column.isSorting('asc') | column.isSorting('desc')" 
                                                    name="arrow_up" 
                                                    stroke-width="1" 
                                                    class="h-4 text-gray-500"
                                                    :class="{'rotate-180':column.isSorting('desc')}"
                                                    />
                                                    <SharedCommonIcon v-else name="chevron_double" class="h-4" />
                                                </span>
                                            </span>
                                        </div>
                                    </th>

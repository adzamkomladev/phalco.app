...
<div class="flex flex-col h-full bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
  <!-- Body -->
  <div class="p-4 md:p-5 space-y-7">
    <div>
      ...
      <div class="mb-2 flex justify-between items-center">
        <div class="flex items-center gap-x-3">
          <span class="size-8 flex justify-center items-center border border-gray-200 text-gray-500 rounded-lg dark:border-neutral-700 dark:text-neutral-500">
           <SharedCommonIcon name="upload" />
          </span>
          <div>
            <p class="text-sm font-medium text-gray-800 dark:text-white">preline-ui.html</p>
            <p class="text-xs text-gray-500 dark:text-neutral-500">7 KB / 1Mb</p>
          </div>
        </div>
      ...
      <SharedCommonProgressBar  :progress="0" :total="10" height="8px" unloadedClass="bg-gray-100"  />
      <!-- End Progress Bar -->
    </div>

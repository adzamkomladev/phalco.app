...
<template>
    <a
        :href="'#' + to"
        class="relative group text-base md:text-lg text-black text-nowrap hover:text-primary-500 font-medium capitalize pb-4 focus:outline-none focus:text-neutral-300"

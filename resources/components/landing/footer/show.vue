...
<div class=" col-span-3 _md:py-8 flex items-center gap-8 justify-center h-5">
    <SharedCommonIcon name='logo_full' class="w-full md:text-primary-500 scale-200"/>
</div>

            <div class="col-span-6 grid font-light  grid-cols-3 gap-6 xl:gap-10 lg:space-y-0">
   <div class="flex flex-col gap-2">
    <p class="font-bold md:text-black">About Us</p>
    <p class="font-thin">Lorem ipsum </p>
    <p>Lorem ipsum </p>
    <p>Lorem ipsum </p>
   </div>
   <div class="flex flex-col gap-2">
...
<SharedCommonIcon :name="social.icon" class="w-8 h-8" />
    </button>
 </div>  
</div>

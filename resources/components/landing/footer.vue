...
<div class=" flex items-center gap-8 justify-center h-5">
    <SharedCommonIcon name="logo_full" class="h-24 scale-200"/>
            ...
            <div class="grid font-light  grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">

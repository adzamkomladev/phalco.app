...
<template>
    <SharedCommonCard class="col-span-4 gap-2 flex flex-col relative p-[8%] py-10">
        <div class="grid grid-cols-5 gap-2 _xs:flex flex-col">
            ...
            <div class="absolute top-5 right-5 p-1 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 group">
                <SharedCommonIcon name="chevron" class="rotate-90 dark:text-gray-400 size-6 group-hover:translate-x-1 transition-all duration-300 group-hover:text-primary-300 dark:group-hover:text-primary-500" />
            </div>
        </div>

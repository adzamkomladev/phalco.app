...
const hasSublink = computed(() => props.menu.sublink && props.menu.sublink.length > 0);
...
<template>
    <div class="capitalize">
        ...
        <router-link
            ...
            v-if="menu.to && !hasSublink"
            :href="route(menu.to)"
            :class="[isCurrentRoute && 'bg-secondary-500  text-white pointer-events-none',menu.icon && 'px-2.5' ]"

<template>
    ...
    >
        <rect width="23.9277" height="23.9277" fill="url(#pattern0_93_417)" />
        <defs>
            <pattern
                id="pattern0_93_417"

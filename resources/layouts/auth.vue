    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    class="portrait:pt-8  2xl:landscape:pt-10 -mt px-[10%] sm:portrait:px-[14%] sm:landscape:mt-0 pb-10 sm:landscape:px-0 sm:landscape:pr-[5vw] xl:pr-[8vw] z-10 bg-white rounded-t-[2.5rem] sm:landscape:rounded-t-none flex-1 sm:landscape:overflow-y-auto sm:landscape:h-screen dark:bg-gray-800"
                >

...
<template>
  ...
  >
    <main class="h-full w-full self-center max-w-[1300px] min-h-screen">
      <div class="relative w-full">
        <div
          :class="[loginIn && 'pt-[84px]']"
          class="sticky pb-4 top-0 z-10 w-full place-content-center flex flex-col gap-5"
        >
          <nav
            v-if="!loginIn"
            class="px-4 sm:px-6 flex items-center w-full mx-auto py-2 border border-t-0 h-16"
          >
          ...
          <div class="flex gap-10 w-fit text-lg relative place-self-center">
            ...
            >
              ...
              <div
                ...
                :class="[!isMessages ? 'w-full' : 'w-0 delay-200']"
              />
            </router-link>
        ...
        <div class="fixed top-36 w-full max-w-[1300px]">
          <transition name="fade" mode="out-in">
            <div
              class="h-[calc(100vh-144px)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-700"
            >
              <slot />
            </div>
          </transition>

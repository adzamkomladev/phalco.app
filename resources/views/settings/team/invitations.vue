...
<p class="flex text-gray-500"><SharedCommonIcon name="invitation" class="self-center " /> <span> {{isOpen ? 'close':'open'}} invitation Status</span></p>     
    <SharedCommonIcon 
    :class="['h-4 self-center transition-transform duration-500 ',isOpen ? 'rotate-180' : '']"
    name="chevron"
      />
</button>
    ...
    <SettingsTeamInvitationTable :data="props.invitations" />
            ...
            class="text-primary-400 flex gap-4 items-center">
                 <router-link

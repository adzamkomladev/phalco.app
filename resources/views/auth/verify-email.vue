...
<template layout="auth">
    ...
    >
        <div class="-mt-5 text-gray-500">
            <p>To start using Phalco, confirm your email address with the email we sent to :
            <strong class="font-bold text-primary-500">{{ user?.email }}</strong></p>
        </div>
        <div class="grid gap-y-8 pt-2">
            <Transition name="fade">
             ...
             <Transition name="fade">
                    <p v-if="showResend" class="mt-3 flex justify-center">
            <SharedFormSubmitButton  @click="resend()" text="Resend Email" /></p></Transition>
        </div>
        <div class="">
            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                Need help ?
...
<!-- <AuthInnerLayout
    ...
    >
        ...
        <form @submit.prevent="verification.submit">
            <div class="grid gap-y-8 pt-2">

                <SharedFormSubmitButton
                    :isLoading="verification.processing"
                    text="Resend Email"
                />

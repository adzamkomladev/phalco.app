...
<template layout="main">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 max-w-6xl self-center _sm:px-[5%]">
            <!-- Card -->
      ...
      <SharedCommonIcon name="tri" class="rounded text-forest-500 size-7" stroke-width="2" />
    </div>
            </ElectionsOngoingStatsCardSmall>
                        ...
                        >
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    ...
                                    >
                                        <SharedCommonIcon name="chevron" class="-rotate-90"/>
                                        Prev
                                    </button>

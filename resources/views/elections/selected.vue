...
<template layout="main">
    <!-- Card Section -->
    <div class="max-w-[85rem] px-4 py-5 flex flex-col gap-8 text-gray-800 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <!-- Grid -->
        <div class="">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
                Lorem ipsum dolor sit, amet consectetur
                    ...
                    <SharedCommonCard class="divide-y gap-2 flex flex-col">
                        <div class="flex items-center gap-2 ">
                            <span class=" rounded-full bg-primary-500  w-fit aspect-square p-2 flex items-center justify-center">
                                <SharedCommonIcon name="logo" class=" text-white "/>
                            </span>
                            <span class="font-bold text-2xl">Phalco</span>
                        </div>
                        <div class="grid grid-cols-4 xl:grid-cols-5 _xs:divide-y _xs:grid-cols-2 gap-6 py-2">
                            ...
                            <div class="grid grid-cols-2 gap-4 col-span-2">
                                <div class="flex gap-4">
                                    <SharedCommonIcon name="creament" class="transform scale-y-[-1] size-6" />
                                    <span class="text-gray-500">
                                        Status
                                    </span>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 col-span-2">
                                <div class="flex gap-4">
                                    <SharedCommonIcon name="greet" class="transform  size-6" />
                                    <span class="text-gray-500">
                                        Assignee
                                    </span>
                                </div>
...
<div class="flex items-center gap-x-3">
        ...
        <div
            class="grid md:grid-cols-2 px-auto    xl:grid-cols-4  gap-4 sm:gap-6  _sm:px-[5%]"
        >
